...
/**
 * Custom ExceptionMapper to handle any generic Exception.
 * This class maps any unhandled exceptions to a Response with a Internal Server Error status code (500)
 * and logs the error details using SLF4J logger.
 */
@Slf4j
@Provider
